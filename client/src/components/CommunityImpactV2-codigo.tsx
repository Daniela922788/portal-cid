...
import { PieChart, LineChart, TrendingUp, Award } from "lucide-react";
...
export default function CommunityImpactV2() {
  const totalImpactados = 1014;
  const totalImpactados2024 = 458;
  const [selectedCategory, setSelectedCategory] = useState("all");

  const programs = [
    { label: "Gestores", value: 268, color: "#3b82f6", dotClass: "bg-blue-500" },
    { label: "Visitas Guiadas", value: 67, color: "#06b6d4", dotClass: "bg-cyan-500" },
    { label: "Impacto Maker", value: 332, color: "#14b8a6", dotClass: "bg-teal-500" },
    { label: "Talento Tech", value: 260, color: "#22c55e", dotClass: "bg-green-500" },
    { label: "Tigo", value: 40, color: "#84cc16", dotClass: "bg-lime-500" },
    { label: "SENA", value: 47, color: "#eab308", dotClass: "bg-yellow-500" },
  ];

  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 pt-16 pb-20">
      {/* Header */}
      <motion.div
      ...
      >
        ...
        <p className="text-lg text-slate-600 max-w-3xl mx-auto px-4">
          Análisis detallado del alcance e impacto del Centro de Ciencia en la comunidad durante 2024-2025
        </p>
      </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-4 mb-20">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            ...
            {
              label: "Total 2024",
              value: totalImpactados2024,
              icon: "📊",
              color: "from-purple-500 to-purple-600",
            },
            {
              label: "Crecimiento",
              value: totalImpactados - totalImpactados2024,
              icon: "📈",
      ...
      >
        <h2 className="text-2xl font-bold text-slate-900 mb-6 flex items-center gap-2">
          ...
          Desglose por Sector y Programa
        </h2>
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-slate-900 text-white">
                ...
                <th className="px-4 py-3 text-center font-semibold bg-blue-600">Total</th>
              </tr>
            </thead>
            <tbody>
              {impactData.map((row, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-slate-700">{row.subcategory}</td>
                  ...
                  <td className="px-4 py-3 text-center font-bold text-white bg-blue-600 rounded">
                    {row.total}
                  </td>
                </motion.tr>
              ))}
              <tr className="bg-slate-900 text-white font-bold text-lg">
                ...
                <td className="px-4 py-3 text-center bg-blue-700 rounded">1014</td>
              </tr>
            </tbody>
          </table>
        </div>
