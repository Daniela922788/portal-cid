...
export default function Formacion() {
  ...
  const ecards: ECard[] = [
    ...
    },
    {
      ...
      trabajado: [
        "Relatos y memoria ambiental",
        "Diálogo comunitario",
        "Adaptación local",
      ],
      enfoque: "Construcción de memoria colectiva y reflexión territorial en torno al clima.",
      metodologias: ["Diálogo comunitario", "Construcción de memoria", "Taller participativo"],
      enfoqueCierre: "Fortalecimiento de la comprensión territorial y estrategias de adaptación.",
      competencias: ["Observación del entorno", "Comprensión territorial", "Adaptación climática"],
    ...
    },
    {
      ...
      trabajado: [
        "Operación básica de drones",
        "Observación y monitoreo territorial",
        "Análisis de riesgos desde imágenes aéreas",
      ],
      enfoque: "Integración de tecnologías de observación para la gestión del territorio.",
      metodologias: ["Prácticas de vuelo", "Análisis de imágenes", "Talleres participativos"],
  ...
  const wideImageCourseTitles = new Set(
    [
      ...
      "Marketing Digital",
      "Historias del clima",
      "Miradas del territorio: Mapeando el riesgo",
